...
echo "<tr><td><a href='View/Fabricante/cadastrar.php'>Cadastrar</a></td></tr>";
...
foreach ($fabricantes as $fabricante) {
    ...
    echo "<td>
                 <a href='View/Fabricante/editar.php?id={$id}'>Editar</a> |
                <a href='View/Fabricante/deletar.php?id={$id}' onclick=\"return confirm('Tem certeza que deseja excluir este fabricante?')\">Deletar</a>
            </td>";
    echo "</tr>";
}
echo "</table>";
